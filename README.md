...
The default conversion format is mp3. If you want to change it, change the value of `target_format` in `configs/config.json` (ex: "wav", "aac").
The default display language is English. If you want to change it, change the value of `language` in `configs/config.json` (ex: "ja", "cn", "kr").
